<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ProductDetails.aspx.cs" Inherits="Complaint_project1.Admin.ProductDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <form id="form1" runat="server" style="margin-top:50px">
            ...
            <asp:Button ID="Button1" runat="server" Text="Add" style="margin-left: 572px" Width="116px" OnClick="Button1_Click"/><br /><br />
