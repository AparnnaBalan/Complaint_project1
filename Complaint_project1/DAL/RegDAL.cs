...
namespace Complaint_project1.DAL
{
    public class RegDAL
    {
        ...
        {
            string qry = "select s.*,l.username,l.password,l.usertype,l.status from UserReg s inner join login l on s.lid=l.lid where l.status='not confirmed' and usertype='user'";
